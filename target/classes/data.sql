...
INSERT INTO Kanban(nome, posizione, id_shop) VALUES ('Kanban 1', 0, 1);
INSERT INTO Kanban(nome, posizione, id_shop) VALUES ('Kanban 2', 1, 1);
INSERT INTO Cliente(nome, cognome, email, numero_telefono, password) VALUES ('cliente', '1', 'cliente@email.com', '1231231234', '$2a$10$MYAHu0zJni9Y4SZGUN48zuI9/uiiZakDUQenpTx5AdavbDkufgKWW'); -- john2020
INSERT INTO Veicolo(modello, marca, anno_costruzione, targa, numero_telaio, id_cliente) VALUES ('Modello di prova', 'Marca di prova', 2020, 'AA123BB', '12345678901234567', 1);
...
INSERT INTO Ordine(appuntamento_fissato, commento_cliente, data_creazione, data_scadenza, titolo, autorizzato, raccomandazione, pagamento_effettuato, ricavo, costo_totale, id_kanban, id_cliente, targa, numero_telaio) VALUES ('2020-01-01 00:00:00', 'Commento di prova', '2020-01-01 00:00:00', '2020-01-01 00:00:00', 'Titolo di prova', 0, 'Raccomandazione di prova', 0, 0.0, 0.0, 1, 1, 'AA123BB', '12345678901234567');
INSERT INTO Ordine(appuntamento_fissato, commento_cliente, data_creazione, data_scadenza, titolo, autorizzato, raccomandazione, pagamento_effettuato, ricavo, costo_totale, id_kanban, id_cliente, targa, numero_telaio) VALUES ('2020-01-01 00:00:00', 'Commento di cose importanti', '2020-01-01 00:00:00', '2020-01-01 00:00:00', 'Ordine fantastico!', 0, 'Mi raccomando, portacela più spesso!', 0, 0.0, 0.0, 2, 1, 'AA123BB', '12345678901234567');
