package it.paleocapa.greco.officina.controllers_shared_interfaces.implementations;
...
public class KanbanInterfaceImplementation {
    ...
    private static <T extends UserDetails> String getUserRoleFromUserDetails(Class<T> userDetails) {
        if (userDetails == DipendenteDetails.class) {
            return "dipendente";
        } else if (userDetails == AdminDetails.class) {
            return "admin";
