...
public class LoginSecurityConfig {
    ...
    public static class AdminConfigurationAdapter {
        ...
        public SecurityFilterChain adminFilterChain(HttpSecurity http) throws Exception {
            DaoAuthenticationProvider adminAuthenticationProvider = customAuthenticationProvider(adminUserDetailsService(), "ADMIN");
            return customHttpSecurity(http, "admin", adminAuthenticationProvider);
        }
    ...
    public static class DipendenteConfigurationAdapter {
        ...
        @Bean
        public DipendenteDetailsService dipendenteUserDetailsService() {
            return new DipendenteDetailsService();
        }

        @Bean
        public SecurityFilterChain dipendenteFilterChain(HttpSecurity http) throws Exception {
            DaoAuthenticationProvider clienteAuthenticationProvider = customAuthenticationProvider(dipendenteUserDetailsService(), "DIPENDENTE");
            return customHttpSecurity(http, "dipendente", clienteAuthenticationProvider);
        }
    ...
    public static class ClienteConfigurationAdapter {
        ...
        @Bean
        public ClienteDetailsService clienteUserDetailsService() {
            return new ClienteDetailsService();
        }

        @Bean
        public SecurityFilterChain clienteFilterChain(HttpSecurity http) throws Exception {
            DaoAuthenticationProvider clienteAuthenticationProvider = customAuthenticationProvider(clienteUserDetailsService(), "CLIENTE");
            return customHttpSecurity(http, "cliente", clienteAuthenticationProvider);
        }
